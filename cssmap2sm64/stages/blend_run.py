...
def run(blender, obj_path, textures_dir, output_dir, level_name, area_id, scale, spawn=(0.0, 0.0, 0.0), materials_json=None, background="ABOVE_CLOUDS", props_json=None, bsp_scale=1.0, env_json=None, sky_obj=None, sky_camera_json=None, sky_cube_obj=None, triggers_json=None):
    cmd = [
        blender,
        "--background",
        "--python", str(_SCRIPT),
